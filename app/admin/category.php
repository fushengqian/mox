...
class category extends FARM_ADMIN_CONTROLLER
{
    public function setup()
    {
        $this->crumb(FARM_APP::lang()->_t('分类管理'), "admin/category/list/");
    ...
    public function edit_action()
    {
        ...
        {
            H::redirect_msg(FARM_APP::lang()->_t('指定分类不存在'), '/admin/category/list/');
        }
