...
class core_pagination
{
    ...
    {
        include(ROOT_PATH . 'views/config/pagination.php');
    ...
    public function create_links()
    {
        ...
        else
        {
            ...
            {
                $this->page_base_url = rtrim($this->base_url).'-';
            }
        }
        ...
        if  ($this->first_link !== FALSE AND $this->cur_page > ($this->num_links + 1))
        {
            if ($this -> html_style)
            {
                $first_url = ($this->first_url == '') ? $this->base_url.'.html' : $this->first_url;
            }
            else
            {
                ...
                if ($i >= 0)
                {
                    ...
                    else
                    {
                        ...
                        if ($n == 1)
                        {
                            if ($this -> html_style)
                            {
                                $output .= $this->num_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.'.html">'.$loop.'</a>'.$this->num_tag_close;
                            }
                            else
                            {
                                if( strrchr($this->base_url, '/') == '/')
                                {
