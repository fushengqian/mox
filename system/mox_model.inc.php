...
class MOX_MODEL
{
     ...
     * @return    array
     */
    public function fetch_page($table, $where = null, $order = null, $page = null, $limit = 10, $cols = '*')
    {
        $this->slave();
        
        $select = $this->select();
        
        $select->from($this->get_table($table), $cols);
     ...
     * @return   array
     */
    public function fetch_row($table, $where = null, $order = null, $cols = array())
    {
        $this->slave();
        
        $select = $this->select();
        
        $select->from($this->get_table($table), (!empty($cols) ? $cols : '*'));
