...
(function () {
    var FoxUI = {
        defaults: {
            ...
            cancelText: "取消",
            loaderText: "数据加载中",
            router: true, //默认使用路由，不要乱改，返回键会失效
    ...
    FoxUI.loader = {
        show: function (text, iconClass, wrapClass, duration) {
            FoxUI.mask.show(true);

            var loader = "<div class='fui-loader " + ( !wrapClass && text != 'mini' ? 'fui-loader-tip ' : '') + ( wrapClass && wrapClass != '' ?  wrapClass : '') + "'>";
                    ...
                    if(res.files){
                        ...
                        if (self.container.length >= 1) {
                            ...
                            if (self.params.remove) {
                                         removeHTML += '<span class="image-remove">';
                                if (self.params.removeIcon) {
                                    removeHTML += "<img src='../addons/ewei_shopv2/template/mobile/default/static/images/sctp.png'></img>";
                                } else {
                                    removeHTML += "X";
                                }
                                removeHTML += '</span>';
    ...
    $.fn.date1 = function (options,Ycallback,Ncallback) {
        //插件默认选项
        var that = $(this);
        ...
        //用户选项覆盖插件默认选项
        var opts = $.extend( true, {}, $.fn.date1.defaultOptions, options );
